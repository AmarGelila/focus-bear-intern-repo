...
function process(x, y) {
  let temp = x + y; // add them
  let final = temp * 2; // double it
  console.log(final); // print
  return final; // give back
}

// main
let num1 = 5; // set num1
let num2 = 3; // set num2
let output = process(num1, num2); // call process
```
...
#### Task :-
 ...
 A function that doesn’t properly handle errors or invalid inputs:-
```
...
Improved Error and edge cases handling :-
```
function processUserData(userData) {
